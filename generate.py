...
class CrosswordCreator():
    ...
    def consistent(self, assignment):
        ...
        for var in assignment.keys():
            ...
            if value is None or len(value) != var.length:
                return False
            if value in words_used:
                return False
            words_used.add(value)
                    ...
                    if overlap is not None:
                        ...
                        for neighbor_word in self.domains[neighbor]:
                            if word[i] != neighbor_word[j]:
                                count += 1
            least_constraining.append((word, count))
        
        least_constraining.sort(key=lambda count: count[1])
        return [word for word, _ in least_constraining]
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return unassigned[0][0] if unassigned else None
